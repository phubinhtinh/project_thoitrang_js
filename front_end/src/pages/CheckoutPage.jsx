                ...
                <div key={item.id} className="flex gap-4">
                  <div className="w-20 h-24 bg-surface-variant flex-shrink-0 overflow-hidden">
                    {item.variant?.productColor?.img ? (
                      <img src={item.variant.productColor.img} alt={product.name} className="w-full h-full object-cover" />
                    ) : (
                  ...
                  <div className="flex flex-col justify-between py-1 w-full">
                    <div>
                      ...
                      <p className="font-body text-xs text-secondary mt-1">{item.variant?.size} | {item.variant?.productColor?.color}</p>
                    </div>
