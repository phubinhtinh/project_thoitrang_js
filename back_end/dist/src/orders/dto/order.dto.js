...
exports.UpdatePaymentStatusDto = exports.UpdateOrderStatusDto = exports.CheckoutDto = void 0;
...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], CheckoutDto.prototype, "phoneReceiver", void 0);
__decorate([
    (0, class_validator_1.IsEnum)(['cod', 'banking', 'momo', 'vnpay']),
...
__decorate([
    (0, class_validator_1.IsEnum)(['unpaid', 'paid']),
    __metadata("design:type", String)
