    ...
    const productsData = [
        {
            ...
            variants: [
                { size: 'S', color: 'Charcoal', stockQuantity: 10, sku: 'ATC-CHR-S' },
        ...
        },
        {
            ...
            variants: [
                { size: 'One Size', color: 'Black', stockQuantity: 20, sku: 'ST-BLK-OS' },
            ],
        },
        {
            id: 3,
            ...
            variants: [
                { size: 'S', color: 'Cream', stockQuantity: 12, sku: 'SUT-CRM-S' },
        ...
        },
        {
            ...
            variants: [
                { size: 'M', color: 'Grey', stockQuantity: 18, sku: 'RMK-GRY-M' },
        ...
        },
        {
            ...
            variants: [
                { size: 'M', color: 'Anthracite', stockQuantity: 8, sku: 'SWO-ANT-M' },
